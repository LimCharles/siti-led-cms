...
export interface ApiCustomerBrandCustomerBrand
  extends Struct.CollectionTypeSchema {
  collectionName: 'customer_brands';
  info: {
    displayName: 'Customer Brand';
    pluralName: 'customer-brands';
    singularName: 'customer-brand';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::customer-brand.customer-brand'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    altImages: Schema.Attribute.Component<'image.image', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    mainImage: Schema.Attribute.Component<'image.image', false>;
    name: Schema.Attribute.String;
